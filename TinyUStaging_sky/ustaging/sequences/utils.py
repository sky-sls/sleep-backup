...
def batch_wrapper(generator, x_shape, y_shape,
    ...
    for i, (xx, yy) in enumerate(generator):
        ...
        try:
            ...
            # print("DEBUG batch_wrapper ValueError:", e)
            # print("  xx.shape =", xx.shape)
            # print("  yy.shape =", yy.shape)
            # print("  expected x slot =", x_batch[batch_ind].shape)
            # print("  expected y slot =", y_batch[batch_ind].shape)
            continue
...
def get_batch_sequence(dataset_queue,
                       ...
                       **kwargs):
    """
    Return a ustaging.sequences BatchSequence object made from a dataset queue.
