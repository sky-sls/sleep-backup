import numpy as np
from ustaging.sequences.base_sequence import _BaseSequence
...
def _assert_comparable_sequencers(sequencers):
    """
    Takes a list of ustaging.sequencer Sequence objects and compares them for
...
class ValidationMultiSequence:
    ...
    The ustaging.callbacks Validation callback performs validation using all
