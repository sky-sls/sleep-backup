...
from ustaging.preprocessing.dataset_preparation.utils import download_dataset
...
def phys_paths_func(file_name, server_url, out_dataset_folder):
    """
    See ustaging/preprocessing/dataset_preparation/utils.py [download_dataset]
...
def preprocess_phys_hypnograms(dataset_folder_path):
    ...
    from ustaging.bin.extract_hypno import to_ids
