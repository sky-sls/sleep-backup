...
class AbstractBaseSleepStudy(ABC):
    ...
    @property
    def hypnogram(self):
        """ Returns the hypnogram (see ustaging.hypnogram), may be None """
    ...
    def alternative_select_channels(self, channels):
        ...
        if channels is not None:
            ...
            if len(channels) == 1:
                from ustaging.utils import ensure_list_or_tuple
    ...
    def plot_period(self, period_idx=None, period_sec=None, out_path=None):
        ...
        from ustaging.visualization.psg_plotting import plot_period
    ...
    def plot_periods(self, period_idxs=None, period_secs=None, out_path=None,
        ...
        from ustaging.visualization.psg_plotting import plot_periods
