...
import numpy as np
from ustaging import errors
from ustaging.io.high_level_file_loaders import load_psg, load_hypnogram
from ustaging.preprocessing import (apply_scaling, strip_funcs, apply_strip_func,
                                 assert_scaler, set_psg_sample_rate,
                                 quality_control_funcs, assert_equal_length,
                                 apply_quality_control_func)
from ustaging.hypnogram.utils import create_class_int_to_period_idx_dict
from ustaging.dataset.sleep_study.subject_dir_sleep_study_base import SubjectDirSleepStudyBase
...
class SleepStudy(SubjectDirSleepStudyBase):
    ...
    def __init__(self,
        ...
        (refer to the 'ustaging.dataset.utils.find_psg_and_hyp' function).
    ...
    def load_time_random_channel_selector(self, channel_selector):
        ...
        if channel_selector and self.select_channels:
            raise RuntimeError("Setting the 'load_time_random_channel_selector' "
                               ...
                               "'select_channels'")
        from ustaging.io.channels import RandomChannelSelector
    ...
    def set_quality_control_func(self, quality_control_func, **kwargs):
        ...
        Args:
            qc_func:  A string naming a quality control function in:
                      ustaging.preprocessing.quality_control_funcs
    ...
    def _load_with_any_in(self, channel_sets):
        ...
        for i, channel_set in enumerate(channel_sets):
            try:
                ...
                print("ljy-log-20221027: self.header_file_path: ", self.header_file_path)
                print(f"ljy-log-20221027: psg.shape={psg.shape}", "\nheader: ", header)
                return psg, header
