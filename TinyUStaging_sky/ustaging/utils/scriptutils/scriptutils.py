"""
A set of utility functions used across multiple scripts in ustaging.bin
"""

import os
from ustaging.utils.utils import ensure_list_or_tuple
...
def get_dataset_splits_from_hparams(hparams, splits_to_load,
    ...
    """
    from ustaging.dataset import SleepStudyDataset
...
def get_dataset_from_regex_pattern(regex_pattern, hparams, logger=None):
    ...
    """
    from ustaging.dataset.sleep_study_dataset import SleepStudyDataset
    ann_dict = hparams.get("sleep_stage_annotations")
