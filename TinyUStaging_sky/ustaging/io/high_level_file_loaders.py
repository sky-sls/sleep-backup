...
import h5py
from ustaging.io.psg import extract_psg_data
from ustaging.io.hypnogram import extract_hyp_data
from ustaging.io.header import extract_header
from ustaging.io.channels.utils import get_org_include_exclude_channel_montages
...
def load_psg(psg_file_path,
    ...
    org_channels, include_channels, exclude_channels, montage_creator = \
        get_org_include_exclude_channel_montages(
            # load_channels=load_channels, # 20210721
...
def load_hypnogram(file_path, period_length_sec, annotation_dict, sample_rate):
    """
    Returns a ustaging.hypnogram SparseHypnogram object representation of the
...
def open_h5_archive(h5_file_path,
    ...
    # Work out which channels to include and exclude during loading
    # org_channels, include_channels, _ = \  # 20210721
