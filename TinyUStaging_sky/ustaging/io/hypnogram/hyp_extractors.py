...
Functions in ustaging.io.extractors.hyp_extractors will convert these data types
into ustaging.hypnogram objects which are used for all downstream operations.
"""

import os
from ustaging.hypnogram.formats import StartDurationStageFormat
from ustaging.hypnogram.utils import sparse_hypnogram_from_ids_format, ndarray_to_ids_format
...
def extract_from_edf(file_path, **kwargs):
    ...
    See ustaging.hypnogram.formats.StartDurationStageFormat
