...
class UStaging4(Model):
    ...
    def __init__(self,
        ...
        self.logger(f"************ ljy --- ratio_se:{ratio_se} ************ ")
        self.logger(f"************ ljy --- ratio_cbam:{ratio_cbam} ************ ")
    ...
    def create_encoder(self,
        ...
        for i in range(depth):
            ...
            if attention_module_encoder_layer == i:  # 推荐为3（与pool_size=10相联合，抵消积极下采样带来的空间信息丢失）
                ...
                self.logger("ljy--- [Encoder(Downsample)] - in_.get_shape().as_list(): ",
    ...
    def create_seq_modeling(self,
        ...
        if attention_module_seq is not None:
            ...
            self.logger("ljy--- [Seq (after Avg Pooling)] - cls.get_shape().as_list(): ",
                        cls.get_shape().as_list())  # [None, 23/31*3840, 1, 7]
