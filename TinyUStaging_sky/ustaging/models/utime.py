...
class UTime(Model):
    ...
    def __init__(self,
                 ...
                 batch_shape,
                 depth=4,
                 dilation=2,  # TODO: ASPP + 避免gridding effect
                 activation="elu",
    ...
    def create_dense_modeling(self,
        ...
        print("ljy--- [create_dense_modeling(1*1 Conv)] - cls.get_shape().as_list(): ", cls.get_shape().as_list())
        print("ljy--- [create_dense_modeling(1*1 Conv)] - in_reshaped.get_shape().as_list(): ", in_reshaped.get_shape().as_list())
